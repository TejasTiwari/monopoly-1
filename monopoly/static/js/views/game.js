...
class GameView {
  ...
  handleStatusChange(message) {
    ...
    console.log(message.action, "HANDLE STATUS CHANGE")
  ...
  changePlayer(nextPlayer, onDiceRolled) {
    ...
    let tradeView;
    console.log("change player", nextPlayer);
    ...
    if (nextPlayer === this.myPlayerIndex && this.afk) {
      this.afkHandler()
    }
  }
